...
export const config = {
  light: vars({
    '--color-primary-0': '#f3f8ff',
    '--color-primary-50': '#deebff',
    '--color-primary-100': '#b9d5ff',
    '--color-primary-200': '#95c0ff',
    '--color-primary-300': '#71aaff',
    '--color-primary-400': '#4d94ff',
    '--color-primary-500': '#2b7fff',
    '--color-primary-600': '#1a73f9',
    '--color-primary-700': '#0e68ef',
    '--color-primary-800': '#1360d5',
    '--color-primary-900': '#1759bb',
    '--color-primary-950': '#1a51a3',

    /* Secondary  */
    '--color-secondary-0': '#d1ebff',
    '--color-secondary-50': '#9ed5ff',
    '--color-secondary-100': '#76c4ff',
    '--color-secondary-200': '#4fb3ff',
    '--color-secondary-300': '#27a1ff',
    '--color-secondary-400': '#058ff9',
    '--color-secondary-500': '#0479d0',
    '--color-secondary-600': '#0a6bb5',
    '--color-secondary-700': '#0d5d9a',
    '--color-secondary-800': '#104f80',
    '--color-secondary-900': '#114267',
    '--color-secondary-950': '#103550',
