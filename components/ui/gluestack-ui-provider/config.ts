...
export const config = {
  light: vars({
    '--color-primary-0': '243 248 255',
    '--color-primary-50': '222 235 255',
    '--color-primary-100': '185 213 255',
    '--color-primary-200': '149 192 255',
    '--color-primary-300': '113 170 255',
    '--color-primary-400': '77 148 255',
    '--color-primary-500': '43 127 255',
    '--color-primary-600': '26 115 249',
    '--color-primary-700': '14 104 239',
    '--color-primary-800': '19 96 213',
    '--color-primary-900': '23 89 187',
    '--color-primary-950': '26 81 163',

    /* Secondary  */
    '--color-secondary-0': '209 235 255',
    '--color-secondary-50': '158 213 255',
    '--color-secondary-100': '118 196 255',
    '--color-secondary-200': '79 179 255',
    '--color-secondary-300': '39 161 255',
    '--color-secondary-400': '5 143 249',
    '--color-secondary-500': '4 121 208',
    '--color-secondary-600': '10 107 181',
    '--color-secondary-700': '13 93 154',
    '--color-secondary-800': '16 79 128',
    '--color-secondary-900': '17 66 103',
    '--color-secondary-950': '16 53 80',
